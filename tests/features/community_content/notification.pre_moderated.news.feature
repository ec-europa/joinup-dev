...
Feature: Notification test for the news transitions on a pre moderated parent.
  ...
  Scenario: Notifications should be sent whenever a news is going through a relevant transition.
    ...
    And news content:
      ...
      | CCN pre propose               | CC member      | body | CCN pre propose               | CC pre community | draft            |
      | CCN pre request changes       | CC member      | body | CCN pre request changes       | CC pre community | validated        |
      | CCN pre report                | CC member      | body | CCN pre report                | CC pre community | validated        |
      | CCN pre request deletion      | CC member      | body | CCN pre request deletion      | CC pre community | validated        |
      | CCN pre propose from reported | CC member      | body | CCN pre propose from reported | CC pre community | needs_update     |
      | CCN pre approve proposed      | CC member      | body | CCN pre approve proposed      | CC pre community | proposed         |
      | CCN pre reject deletion       | CC member      | body | CCN pre reject deletion       | CC pre community | deletion_request |
      | CCN pre delete                | CC member      | body | CCN pre delete                | CC pre community | deletion_request |
      | CCN validated to delete       | CC member      | body | CCN pre delete                | CC pre community | validated        |
      | CCN validated to revise       | CC member      | body | CCN pre revise                | CC pre community | validated        |
    ...
    Then the email sent to "CC owner" with subject "Joinup: Content has been proposed" contains the following lines of text:
      | text                                                                                                              |
      | CC Member has submitted a new news - "CCN create propose" for publication in the community: "CC pre community". |
    ...
    Then the following email should have been sent:
      ...
      | body      | CC Member has submitted an update of the news - "CCN create propose" for publication in the community: "CC pre community". |
    And the email sent to "CC owner" with subject "Joinup: Content has been proposed" contains the following lines of text:
      | text                                                                                                                         |
      | CC Member has submitted an update of the news - "CCN create propose" for publication in the community: "CC pre community". |
      | If you think this action is not clear or not due, please contact Joinup Support at                                           |
    ...
    Then the following email should have been sent:
      ...
      | body      | CC Facilitator has published the new news - "CCN create publish" in the community: "CC pre community".You can access the new content at the following link: http |
    ...
    Then the email sent to "CC owner" with subject "Joinup: Content has been proposed" contains the following lines of text:
      | text                                                                                                           |
      | CC Member has submitted a new news - "CCN pre propose" for publication in the community: "CC pre community". |
      | If you think this action is not clear or not due, please contact Joinup Support at                             |
    ...
    Then the email sent to "CC owner" with subject "Joinup: Content has been updated" contains the following lines of text:
      | text                                                                                                                                                                  |
      | CC Member has updated the content of the news - "CCN pre propose from reported" as advised and requests again its publication in the community: "CC pre community". |
      | If you think this action is not clear or not due, please contact Joinup Support at                                                                                    |
    ...
    Then the email sent to "CC owner" with subject "Joinup: Content has been updated" contains the following lines of text:
      | text                                                                                                                                                                        |
      | CC Member has requested to delete the news - "CCN pre request deletion" in the community: "CC pre community", with the following motivation: "I just want to delete it.". |
      | If you think this action is not clear or not due, please contact Joinup Support at                                                                                          |
    ...
    Then the following email should have been sent:
      | recipient | CC owner                                                                                                                          |
      | subject   | Joinup: Content has been proposed                                                                                                 |
      | body      | CC Member has submitted an update of the news - "CCN validated to revise" for publication in the community: "CC pre community". |
    ...
    Then the following email should have been sent:
      | recipient | CC owner                                                                                              |
      | subject   | Joinup: Content has been published                                                                    |
      | body      | CC Facilitator has published the new news - "CCN pre publish" in the community: "CC pre community". |
    ...
    Then the email sent to "CC member" with subject "Joinup: Content has been updated" contains the following lines of text:
      | text                                                                                                                                                                                                |
      | the Facilitator, CC Facilitator has requested you to modify the news - "CCN pre request changes" in the community: "CC pre community", with the following motivation: "Can you do some changes?". |
      | If you think this action is not clear or not due, please contact Joinup Support at                                                                                                                  |
    But the following email should not have been sent:
      | recipient | CC owner                                                                                                                               |
      | subject   | Joinup: Content has been proposed                                                                                                      |
      | body      | CC Facilitator has submitted an update of the news - "CCN pre request changes" for publication in the community: "CC pre community". |
    ...
    Then the email sent to "CC member" with subject "Joinup: Content has been updated" contains the following lines of text:
      | text                                                                                                                                                                                       |
      | the Facilitator, CC Facilitator has requested you to modify the news - "CCN pre report" in the community: "CC pre community", with the following motivation: "Your content is reported". |
      | If you think this action is not clear or not due, please contact Joinup Support at                                                                                                         |
    ...
    Then the following email should have been sent:
      ...
      | body      | the Facilitator, CC Facilitator has approved your request of publication of the news - "CCN pre approve proposed" in the community: "CC pre community". |
    ...
    Then the following email should have been sent:
      | recipient | CC member                                                                                                                                                                                              |
      | subject   | Joinup: Content has been updated                                                                                                                                                                       |
      | body      | the Facilitator, CC Facilitator has not approved your request to delete the news - "CCN pre reject deletion" in the community: "CC pre community", with the following motivation: "I still like it". |
    ...
    Then the following email should have been sent:
      ...
      | body      | Facilitator CC Facilitator has approved your request of deletion for the news - "CCN pre delete" in the community: "CC pre community". |
    ...
    Then the following email should have been sent:
      | recipient | CC member                                                                                                                                          |
      | subject   | Joinup: Content has been deleted                                                                                                                   |
      | body      | Facilitator CC Facilitator has approved your request of deletion for the news - "CCN pre request deletion" in the community: "CC pre community". |
    ...
    Then the following email should have been sent:
      | recipient | CC member                                                                                                           |
      | subject   | Joinup: Content has been deleted                                                                                    |
      | body      | Facilitator CC Facilitator has deleted the news - "CCN validated to delete" in the community: "CC pre community". |
