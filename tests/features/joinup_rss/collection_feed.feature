...
Feature: Collection RSS feed.
  ...
  Scenario: Collection RSS feed.
    ...
    And the RSS feed items should be:
      ...
      | News: New metal alloy improves scissors | /collection/indigo-moneky/news/new-metal-alloy-improves-scissors | It improves sharpness but they are more subject to rust.                                                                                                                                                | Wed, 11 Apr 2018 09:00:00 +0200 | Otto Drake |
