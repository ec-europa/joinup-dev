...
Feature: Collection RSS feed.
  ...
  Scenario: Collection RSS feed.
    ...
    And the RSS feed items should be:
      ...
      | Discussion: Is the indigo coloration caused by their food? | /discussion/indigo-coloration-caused-their-food | I was reading the technical paper and it seems their main food is the indigo cherries. | Mon, 21 Jan 2019 13:00:00 +0100 | Aleta Jakeman   |
      | News: Monkeys favourite indigo amongst colors              | /news/monkeys-favourite-indigo-amongst-colors   | Research results are out.                                                              | Mon, 21 Jan 2019 12:36:00 +0100 | Aleta Jakeman   |
      ...
      | Event: Banana tasting                                      | /event/banana-tasting                           | Testing more than 20 varities of bananas from all over the world.                      | Fri, 14 Sep 2018 07:36:00 +0200 | Forest Robinson |
      ...
      | Document: Indigo technical paper                           | /document/indigo-technical-paper                | All technical information about the rare indigo monkeys.                               | Mon, 30 May 2016 12:21:00 +0200 | Aleta Jakeman   |
    ...
    And the RSS feed items should be:
      ...
      | News: New metal alloy improves scissors | /news/new-metal-alloy-improves-scissors | It improves sharpness but they are more subject to rust.                                                                                                                                               | Wed, 11 Apr 2018 09:00:00 +0200 | Otto Drake |
      | Event: Scissor sharpening party         | /event/scissor-sharpening-party         | The place where to be if you want to keep cutting the paper at the best of your scissors possibilities . Lorem ipsum dolor sit amet consectetur adipiscing elit. Etiam sed consectetur turpis. In porta | Sun, 26 Nov 2017 14:18:00 +0100 | Otto Drake |
