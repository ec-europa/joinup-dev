...
Feature: Solution RSS feed.
  ...
  Scenario: Solution RSS feed.
    ...
    And solutions:
      | title             | state     | author  | creation date          |
      | Lantern Domestic  | validated | scorlan | 2018-12-18 08:00 +0100 |
      | Deuteron Lonesome | draft     | scorlan | 2019-01-05 10:00 +0100 |
    ...
    And event content:
      | title                      | body                                                                                                                                                                                                                                                                                                                                                                                            | state     | author  | created                | solution         |
      | Scissor sharpening funeral | value: <p>The place where to be if you want to keep <strong>cutting</strong> the paper at the best of your scissors <a href="http://www.example.com/">possibilities</a>.</p> <table><tr><td>Lorem ipsum dolor sit amet consectetur adipiscing elit. Etiam sed consectetur turpis. In porta lectus sit amet nulla feugiat et viverra massa fringilla.</td></tr></table> - format: content_editor | validated | scorlan | 2017-11-26 14:18 +0100 | Lantern Domestic |
    ...
    Then the page should contain an RSS autodiscovery link with title "Latest updates from the Lantern Domestic solution" pointing to "/solution/lantern-domestic/feed.xml"
    ...
    And the RSS feed channel elements should be:
      ...
      | link        | /solution/lantern-domestic                                                          |
    And the RSS feed should have 4 items
    And the RSS feed items should be:
      | title                                     | link                                                                | description                                                                                                                                                                                            | publication date                | author        |
      | News: Monkeys worst indigo amongst colors | /solution/lantern-domestic/news/monkeys-worst-indigo-amongst-colors | <p>Research results are out.</p>                                                                                                                                                                       | Mon, 21 Jan 2019 12:36:00 +0100 | Sartin Corlan |
      | News: Old metal alloy improves scissors   | /solution/lantern-domestic/news/old-metal-alloy-improves-scissors   | <p>It improves sharpness but they are more subject to rust.</p>                                                                                                                                        | Wed, 11 Apr 2018 10:00:00 +0200 | Sartin Corlan |
      | Event: Scissor sharpening funeral         | /solution/lantern-domestic/event/scissor-sharpening-funeral         | The place where to be if you want to keep cutting the paper at the best of your scissors possibilities. Lorem ipsum dolor sit amet consectetur adipiscing elit. Etiam sed consectetur turpis. In porta | Sun, 26 Nov 2017 14:18:00 +0100 | Sartin Corlan |
      | Custom page: Indigo variations            | /solution/lantern-domestic/indigo-variations                        | <p>The four major tones of indigo are listed here.</p>                                                                                                                                                 | Sun, 15 Oct 2017 19:30:00 +0200 | Sartin Corlan |
