...
Feature: Homepage feature
  ...
  Scenario: Show content related to groups the user belongs to on the homepage.
    ...
    And news content:
      | title                     | body                      | topic             | community          | state     | visits | created          |
    ...
    # Only content of communities I am a member of are shown.
    But I should not see the "Girl in the Dreams" tile

    # Show new list of content when I join a community.
    When I go to the homepage of the "Boy of Courage" community
    ...
    # Show new list of content when I leave a community.
    When I go to the homepage of the "Boy of Courage" community
    ...
    When I am logged in as a facilitator of the "The Sacred Future" community
    And I go to the homepage of the "The Sacred Future" community
