...
Feature: User registration
  ...
  Scenario: A moderator can register a user
    ...
    Then the following email should have been sent:
      ...
      | body      | The COVID-19 Challenge Support Team created your account on COVID-19 Challenge. Please log in through the following link in order to set your password. |
