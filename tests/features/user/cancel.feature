...
Feature:
  ...
  Scenario: A moderator cancels a user account.
    ...
    And the following email should have been sent:
      ...
      | body           | Your account alicia__1997 has been deleted.This action has been done in the framework of moderation activities regularly conducted on the COVID-19 Challenge platform. If you believe that this action has been performed by mistake, please contact The Joinup Support Team at |
  ...
  Scenario: A moderator deletes a user using the administrative UI.
    ...
    When I go to "/challenge/test-challenge/news/news-item"
  ...
  Scenario: Cancel own account.
    ...
    And document content:
      | title | author       | challenge      | state     |
      | Docky | alicia__1997 | Test challenge | validated |
    And discussion content:
      | title  | challenge      | state     |
      | Disqus | Test challenge | validated |
    And comments:
