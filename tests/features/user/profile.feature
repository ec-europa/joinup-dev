...
Feature: User profile
  ...
  Scenario: A logged-in user can navigate to his own profile and edit it.
    ...
    Then the following fields should be present "Family name, Photo, Country of origin, Professional profile, Professional domain, Business title"
  ...
  Scenario: A moderator can navigate to any users profile and edit it.
    ...
    Then the following fields should be present "Country of origin, Professional profile, Organisation"
    Then the following fields should not be present "Time zone"
