...
Feature: Search inside groups
  ...
  Scenario: Group filters are shown as chips
    ...
    Then the option with text "Chalet construction   (6)" from select facet "challenge/solution" is selected
    ...
    When I submit the search by pressing enter
    Then the option with text "Inclined foundations   (6)" from select facet "challenge/solution" is selected
    ...
    Then the option with text "Inclined foundations   (2)" from select facet "challenge/solution" is selected
  ...
  Scenario: Group filters remain active in the search bar when viewing search results
    ...
    Then the page should show the following chip:
      | Chalet construction |
    When I enter "ground" in the search bar and press enter
    Then the option with text "Chalet construction   (2)" from select facet "challenge/solution" is selected
  ...
  Scenario: Group filter chips appear in search bar after selecting them in facets
    ...
    When I select "Inclined foundations" from the "challenge/solution" select facet
    Then the option with text "Inclined foundations   (6)" from select facet "challenge/solution" is selected
