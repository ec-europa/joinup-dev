...
Feature: "Add document" visibility options.
  ...
  Scenario: Add document as a facilitator.
    ...
    And I should see the success message 'Document The Sparks of the Butterfly has been created as draft. You can find it in the section "My unpublished content" located in your My account page, or in the aforementioned section under the Collection/Solution it was created in.'
