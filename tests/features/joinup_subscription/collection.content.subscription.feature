...
Feature: Subscribing to community content in collections
  ...
  Scenario: Receive a digest of content that is published in my collections
    ...
    Then the daily content subscription digest for hristo should match the following messages:
      | Belt conveyors  |
      | New urbanism    |
      | Duck liver      |
      | Sunflower seeds |
      ...
      | Plovdiv         |
      | Stara Zagora    |
    And the weekly content subscription digest for bisera should match the following message:
      | Duck liver      |
      | Canned cherries |
      | Rose oil        |
      | Sofia           |
      | Stara Zagora    |
      | Burgas          |
    And the monthly content subscription digest for kalin should match the following message:
      | Canned cherries |
      | Sunflower seeds |
      | Sofia           |
      | Plovdiv         |
    ...
    And the daily content subscription digest for hristo should not contain the following messages:
      | Double seaming |
      | Varna          |
    And the weekly content subscription digest for bisera should not contain the following message:
      | Ruse  |
      | Varna |
    And the monthly content subscription digest for kalin should not contain the following message:
      | Ruse |
    ...
    Then the weekly content subscription digest for bisera should include the following message:
      | Ruse |
    And the monthly content subscription digest for kalin should include the following message:
      | Ruse |

    # Check that the messages are formatted correctly.
    Given all message digests have been delivered
    Then the content subscription digest sent to hristo contains the following sections:
      | title                |
      | Cities of Bulgaria   |
      | Plovdiv              |
      | Stara Zagora         |
    ...
    And the content subscription digest sent to bisera contains the following sections:
      | title                |
      | Cities of Bulgaria   |
      | Burgas               |
      | Sofia                |
    ...
    And the content subscription digest sent to kalin contains the following sections:
      | title                |
      | Cities of Bulgaria   |
      | Burgas               |
      | New urbanism         |
    ...
    Then the weekly content subscription digest for bisera should not contain the following message:
      | Ruse |
    And the monthly content subscription digest for kalin should not contain the following message:
      | Ruse |
    When the workflow state of the "Ruse" content is changed to "validated"
    ...
    Then the daily content subscription digest for hristo should include the following messages:
      | Double seaming |
