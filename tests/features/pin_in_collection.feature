@api @email @group-a
Feature: Pinning entities inside communities
  As a facilitator of a community
  I want to pin entities at the top of the community homepage
  ...
  Scenario Outline: Facilitators can pin and unpin community content inside their communities.
    ...
    And I go to the homepage of the "Orange Wrench" community
    ...
    # Members and facilitators of other communities cannot pin nor unpin.
    ...
    # Facilitators of the community the content belongs to can pin/unpin.
    ...
    # When we are not in a community page, the pin/unpin links should not be visible.
    When I am at "/search"
    Then I should not see the contextual links "Pin, Unpin" in the "Useful information" tile
    And I should not see the contextual links "Pin, Unpin" in the "Very important" tile
  ...
  Scenario: Facilitators can pin and unpin solutions inside their communities.
    ...
    When I go to the homepage of the "Cloudy Beam" community
    Then I should see the following tiles in the correct order:
    ...
    # Pinning a solution in a community shouldn't affect the other communities it is affiliated with.
    When I go to the homepage of the "Cloudy Beam" community
    Then I should see the following tiles in the correct order:
      | Multi stratus beaming |
      | Orange estimator      |
  ...
  Scenario Outline: Pinned content tiles should show a visual cue only in their community homepage.
    ...
    # When shared on other community, content shouldn't show the pin icon.
    When I go to the homepage of the "Cloudy Beam" community
    ...
    When I am logged in as a facilitator of the "Orange Wrench" community
    When I go to the homepage of the "Orange Wrench" community
    Then the "Lantern FAQs" tile should be marked as pinned
    But the "Lantern terms" tile should not be marked as pinned
  ...
  Scenario: Pinned solutions tiles should show a visual cue only in their community homepage.
    ...
    # Unpinning a solution from one of the communities it is affiliated with
    # should not affect the state in other communities.
    When I go to the homepage of the "Cloudy Beam" community
