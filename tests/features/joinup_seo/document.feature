...
Feature: SEO for document content.
  ...
  Background:
    Given communities:
      | title                          | state     |
      | Joinup SEO document community | validated |
    And licence:
  ...
  Scenario: Basic metatags are attached as JSON schema on the page.
    Given document content:
      | title        | author            | document type | document publication date       | changed                         | keywords         | short title | file type | file     | body               | licence      | state     | community                     |
      | SEO document | Joinup SEO author | document      | Wed, 25 Dec 2019 13:00:00 +0100 | Wed, 01 Jan 2020 13:00:00 +0100 | key1, key2, key3 | SEO         | upload    | test.zip | Document test1.zip | Some license | validated | Joinup SEO document community |
    ...
    And the following meta tags should available in the html:
      | identifier     | value                                                                        |
      | description    | Document test1.zip                                                           |
      | og:url         | __base_url__/community/joinup-seo-document-community/document/seo-document |
      | og:site_name   | Joinup                                                                       |
  ...
  Scenario: Metatags for remote URL in documents.
    Given document content:
      | title        | author            | document publication date       | changed                         | file type | file                                       | body               | state     | community                     |
      | SEO document | Joinup SEO author | Wed, 25 Dec 2019 13:00:00 +0100 | Wed, 01 Jan 2020 13:00:00 +0100 | remote    | http://example.com/some-file-url.extension | Remote url example | validated | Joinup SEO document community |
