...
Feature: Tests membership to Joinup collection.
  ...
  Scenario: As a newly registered user I'm automatically member of the 'Joinup'
    ...
    Given I am logged in as a user with the member role of the "An arbitrary challenge" collection
    Then I am member of "Joinup" collection

    And I go to the homepage of the "An arbitrary challenge" collection
  ...
  Scenario: As a moderator I am able to revoke the membership of a user to any
    ...
    Then I should see the heading "Are you sure you want to delete the selected membership from the 'An arbitrary challenge' challenge?"
    And I should see "The member joe will be deleted from the 'An arbitrary challenge' challenge."
    And I should see "This action cannot be undone."

    When I press "Confirm"
    Then I should see the success message "The member joe has been deleted from the 'An arbitrary challenge' challenge."
