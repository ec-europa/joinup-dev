@api @terms
Feature: Solution overview
  In order find content around a topic
  As a user of the website
  I need to be able see all content related to a solution on the solution overview
  ...
  Scenario: The solution overview shows related content.
    When I go to the overview page of the "Information sharing protocol" solution
    ...
    When I go to the overview page of the "Security audit tools" solution
  ...
  Scenario: Regression test for Uris that include a '#'.
    Given the following solution:
      ...
      | banner      | banner.jpg                            |
      | state       | validated                             |
    When I go to the overview page of the "Information sharing protocols" solution
  ...
  Scenario: The related content should not be shown in the draft view version as part of the content.
    ...
    And I go to the overview page of the "Information sharing protocol" solution
  ...
  Scenario: Custom pages should not be visible on the solution overview
    Given the following solution:
    ...
    When I go to the overview page of the "Jira restarters" solution
  ...
  Scenario: A link to the first collection a solution is affiliated to should be shown in the solution header.
    ...
    When I go to the overview page of the "Robotic arm" solution
    Then I should see the link "Disappointed Steel"

    When I go to the overview page of the "ARM9" solution
    Then I should see the link "Disappointed Steel"
