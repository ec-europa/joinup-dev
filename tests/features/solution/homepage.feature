...
Feature: Solution homepage
  ...
  Scenario: The solution homepage shows related content
    ...
    And the following distributions:
      | title           | description                                        | file     | solution                     | parent                       |
    ...
    Then I should see the text "IS protocol paper 1"
    ...
    But I should not see the text "PDF version"
    And I should not see the text "ZIP version"
    # Unrelated content should not be shown.
    And I should not see the text "Fireproof"
    And I should not see the text "Code of conduct"
    # Nor the solution itself should be shown.
    And I should not see the text "Information sharing protocol"
    ...
    But I should not see the text "IS protocol paper 1"
    ...
    But I should not see the text "IS protocol paper 1"
    And I should not see the text "Protocol draft"
