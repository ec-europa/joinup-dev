...
Feature: Solutions Overview
  ...
  Scenario: Solutions overview paging
    Given solutions:
  ...
  @terms
  Scenario: View solutions overview as an anonymous user
    Given users:
      | Username      | E-mail                            |
  ...
  Scenario: Solutions overview active trail should persist on urls with arguments.
    Given I am an anonymous user
