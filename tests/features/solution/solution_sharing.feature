...
Feature: As a privileged user
  ...
  Scenario: Share link is visible for privileged users.
    ...
    Then I should see the success message "Item was shared on the following challenges: Collection share candidate 1."
    ...
    Then I should see the success message "Item was unshared from the following challenges: Collection share candidate 1."
