...
Feature: As a privileged user
  ...
  Scenario: Share link is visible for privileged users.
    ...
    And the following fields should be present "Collection share candidate 1, Collection share candidate 2"
    And the following fields should not be present "Collection share original"
