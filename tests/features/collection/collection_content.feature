...
Feature: Given I am visiting the collection homepage
  ...
  Scenario: Test that publishing new solutions result in counters being properly updated.
    ...
    # Publish the solution and verify that the solution counters are updated.
    ...
    # as "Solutions (@count)".
    Then I should see the link "2 Solutions"
    And I see the text "2 Solution" in the "Header" region
