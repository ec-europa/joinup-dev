...
Feature: Organic Groups integration
  ...
  Scenario: Edit a Collection
    ...
    Then the following fields should be present "Title, Description, Abstract, Owner, Policy domain, Topic, Spatial coverage, Affiliates, Closed collection, eLibrary creation, Moderated"
