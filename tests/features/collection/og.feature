...
Feature: Organic Groups integration
  ...
  Scenario: Edit a Collection
    Given collections:
      | title                       | logo     | banner     | abstract                                   | access url                             | closed | creation date    | description                                                                                                        | elibrary creation | moderation |
      | Überwaldean Land Eels       | logo.png | banner.jpg | Read up on all about <strong>dogs</strong> | http://dogtime.com/dog-breeds/profiles | yes    | 28-01-1995 12:05 | The Afghan Hound is elegance personified.                                                                          | facilitators      | yes        |
      | Folk Dance and Song Society | logo.png | banner.jpg | Cats are cool!                             | http://mashable.com/category/cats/     | no     | 28-01-1995 12:06 | The domestic cat (Felis catus or Felis silvestris catus) is a small usually furry domesticated carnivorous mammal. | members           | no         |
    And users:
      | name             | roles         |
    ...
    Then the following fields should be present "Title, Description, Abstract, Contact information, Owner, Policy domain, Spatial coverage, Affiliates, Closed collection, eLibrary creation, Moderated"
