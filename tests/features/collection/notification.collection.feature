...
Feature: Notification test for the collection transitions.
  ...
  Scenario: Notifications should be sent whenever an event is occurring related to a collection.
    ...
    And the following email should have been sent:
      | recipient | NC owner                                                                         |
      | subject   | COVID19 challenge: Your challenge has been deleted by the moderation team        |
      | body      | The COVID19 challenge moderation team deleted the challenge NC to delete by mod |
