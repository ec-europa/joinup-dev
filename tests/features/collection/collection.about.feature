@api @group-a
Feature: About page
  In order to present an overview of the purpose of my community
  As a community owner
  I want to publish details about the community on the About page

  @terms
  Scenario: View community detailed information in the About page
    ...
    When I go to the homepage of the "Fitness at work" community
    ...
    And I should not see the text "This community is intended to show ways of being fit while working"
    ...
    And I should see the text "This community is intended to show ways of being fit while working"
    ...
    # There should be a section explaining how the community is moderated.
    ...
    And I go to the edit form of the "Fitness at work" community
    And I fill in "Abstract" with ""
    And I press "Publish"
    Then I should see the heading "Fitness at work"
    And the page should contain the html text "This community is intended to show ways of being <strong>fit while working</strong>"
