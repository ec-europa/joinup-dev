...
Feature: Collections Overview
  ...
  Scenario: Check visibility of "Collections" menu link.
    ...
    And I should see the text "Collections are the main collaborative space were the content items are organised around a common topic or domain and where the users can share their content and engage their community."
