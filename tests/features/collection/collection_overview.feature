...
Feature: Collections Overview
  Scenario: View collection overview
    Given collections:
      ...
      | eHealth           | Supports health-related fields | Arnold Sideways | http://drupal.org/pagenotfound         |
      | Open Data         | Facilitate access to data sets | Madame Sharn    | http://joinup.eu/collections/eula      |
      | Connecting Europe | Reusable tools and services    | Ptaclusp IIb    | http://joinup.eu/rdf_entity/collection |
