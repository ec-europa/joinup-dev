...
Feature:
  ...
  Scenario: Recommendations page is only accessible through the EIF Toolbox solution.
    ...
    And I go to "/community/test-community/solution/test-solution"
    Then I should see the heading "Test solution"

    When I go to "/community/test-community/solution/test-solution/recommendations"
    ...
    When I go to "/community/nifo-community/solution/eif-toolbox"
    Then I should see the heading "Sign in to continue"
    When I go to "/community/nifo-community/solution/eif-toolbox/recommendations"
    Then the response status code should be 404
