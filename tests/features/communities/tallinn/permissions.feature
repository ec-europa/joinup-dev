...
Feature:
  ...
  Scenario: Test permissions on Tallinn Reports.
    ...
    And tallinn_report content:
      ...
      | Romania | gheorghe  | Kind of Tallinn |
      | France  | dominique | Kind of Tallinn |
    ...
    When I visit the tallinn_report content "France" edit screen
    Then I should get a 403 HTTP response
    ...
    Given I visit the tallinn_report content "France" edit screen
    Then I should get a 403 HTTP response
