...
class FeatureContext extends RawDrupalContext implements SnippetAcceptingContext {
  ...
  /**
   * Forces the indexing of new content after each step.
   *
   * When a Search API index is configured with the 'options.index_directly' set
   * to TRUE, the entity is not indexed immediately being saved, in
   * hook_entity_update(), instead the indexing is postponed to the end of the
   * request. This is OK when operating manually the site, but when this is
