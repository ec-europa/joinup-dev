...
Feature: Homepage
  ...
  Scenario: Explore block shows a selection of news, events, collections and solutions
    ...
    Then the explore section should contain the following content:
      ...
      | solution   | Lantern International       | 2018-12-18 08:00 +0100 | Lantern International Group has started deploying personnel in focused areas. In this quest we have decided to consolidate our private businesses into one entity as a significant step towards…         |
      ...
      | collection | Clash of vettel             | 2020-10-18 08:00 +0100 | The point is that we do have the rights to one of our films. So we could be dealing with a film that we'd normally have to show only for three or four weeks and see what happens. But it's more like a… |
      ...
      | news       | Current biodiversity adapt  | 2021-04-30T19:09:00Z   | Here we combine global maps of human populations and land use over the past 12000 y with current biodiversity data to show that nearly three quarters of nature has long been shaped by histories of…    |
      ...
      | event      | Dark material               | 2021-04-29T10:18:00Z   | The presence of a relatively large magnetic field is acting as a quenching agent. The authors say the observations confirm their hypothesis that there is a strong active magnetic field interacting…    |
