...
Feature: Homepage
  ...
  Scenario: Latest news is shown on the homepage
    ...
    Given news content:
      ...
      | Current biodiversity crisis | Preserve habitats        | Here we combine global maps of human populations and land use over the past 12000 y with current biodiversity data to show that nearly three quarters of nature has long been shaped by histories of human habitation and use by indigenous peoples. | Shaping of nature | Finance in EU, Supplier exchange, E-health | validated | 2021-04-26T19:09:00Z |
      ...
      | Earlier transformations     | Ecosystem management     | Archaeological evidence shows that by 10000 BCE all societies employed ecologically transformative land use practices including burning hunting species propagation domestication cultivation have left long-term legacies across the biosphere.     | Shaping of nature | EU and European Policies                   | validated | 2021-03-29T10:18:00Z |
