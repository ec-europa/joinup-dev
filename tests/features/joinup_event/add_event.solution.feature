...
Feature: "Add event" visibility options.
  ...
  Scenario: Add event as a facilitator.
    ...
    And the following fields should be present "Title, Short title, Description, Agenda, Logo, Contact email, Website, Domain, Add a new file, Scope, Geographical coverage"
