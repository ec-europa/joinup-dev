...
Feature: "Add event" visibility options.
  ...
  Scenario: Add event as a facilitator.
    ...
    And the following fields should be present "Title, Short title, Description, Agenda, Logo, Contact email, Website, Physical location, Organisation, Organisation type, Domain, Add a new file, Keywords, Scope, Geographical coverage"
