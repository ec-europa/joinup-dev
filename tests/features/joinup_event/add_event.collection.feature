...
Feature: "Add event" visibility options.
  ...
  Scenario: Add event as a facilitator.
    ...
    And the following fields should be present "Title, Short title, Description, Agenda, Logo, Additional address info, Contact email, Website, Location, Organisation, Organisation type, Topic, Keywords, Scope"
