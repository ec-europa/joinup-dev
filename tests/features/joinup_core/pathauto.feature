...
Feature:
  ...
  Scenario: Entities should have distinct pathauto aliases.
    ...
    When I go to the "Pathauto challenge" collection
    Then the url should match "challenge/pathauto-challenge"
    ...
    Then the url should match "challenge/pathauto-challenge/document/pathauto-document"
    ...
    Then the url should match "challenge/pathauto-challenge/discussion/pathauto-discussion"
    ...
    Then the url should match "challenge/pathauto-challenge/event/pathauto-event"
    ...
    Then the url should match "challenge/pathauto-challenge/news/pathauto-news"
    When I visit the "Pathauto news 2" news
    Then the url should match "solution/pathauto-solution/news/pathauto-news-2"
    When I visit the "Pathauto challenge page" custom page
    Then the url should match "challenge/pathauto-challenge/pathauto-challenge-page"
