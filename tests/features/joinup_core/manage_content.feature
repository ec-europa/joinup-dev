...
Feature:
  ...
  Scenario: Use the content management UI
    ...
    And I go to the homepage of the "Vintage Art" community
    ...
    Given I am logged in as a facilitator of the "Vintage Art" community
    And I go to the homepage of the "Vintage Art" community
    Then I should not see the link "Manage content"
    ...
    And I fill in "Select the destination community or solution" with "Decadent Art"
    ...
    And the "Decadent Art" community should have a community content titled "The Panama Papers"

    Then I should see "News Exports Leap Despite Currency Gain group was changed to Decadent Art."
    And the "Decadent Art" community should have a community content titled "Exports Leap Despite Currency Gain"

    And I should see "Discussion The Ultimate Debate group was changed to Decadent Art."
    And the "Decadent Art" community should have a community content titled "The Ultimate Debate"

    And I should see "Event Version 2.0 Launch Party group was changed to Decadent Art."
    And the "Decadent Art" community should have a community content titled "Version 2.0 Launch Party"

    And I should see "Custom page HOWTOs group was changed to Decadent Art."
    And the "Decadent Art" community should have a custom page titled "HOWTOs"
    ...
    And the "Decadent Art" community should have a custom page titled "Looking for Support?"

    And I should see "Action processing results: Move to other group (5)."

    # Visit the source community.
    Given I go to the "Vintage Art" community
    ...
    # Visit the destination community.
    Given I go to the "Decadent Art" community
    ...
    When I go to the homepage of the "Decadent Art" community
    And I click "Manage content"
    And I select the "Looking for Support?" row
    And I select "Move to other group" from "Action"
    And I press "Apply to selected items"
    And I fill in "Select the destination community or solution" with "Vintage Art"
    And I press "Apply"
    And I wait for the batch process to finish
    ...
    And the "Vintage Art" community should have a custom page titled "Looking for Support?"
