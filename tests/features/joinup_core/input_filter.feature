...
#      | Joinup iframe           | Sample joinup.ec.europa.eu iframe  | value: <iframe frameborder="0" height="800" marginheight="0" marginwidth="0" src="https://joinup.ec.europa.eu/homepage" width="100%"></iframe> - format: content_editor                                                                                                                                                                                                                                                                                                                                | Netflix group | validated |
