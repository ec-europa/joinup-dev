...
Feature: In order to help moderators manage effectively imported content
  ...
  Scenario: Show a status message to moderators upon login for pipelines that have not run for too long.
    ...
    When the "Joinup community" pipeline was last executed 89 days ago
    And the "Slovenian Interoperability Portal - NIO" pipeline was last executed 92 days ago
    When I am logged in as a moderator
    Then I should not see the warning message "Pipeline Joinup community has not been executed for 89 days."
    ...
    Given the "Joinup community" pipeline was last executed 91 days ago
    When I am not logged in
    And I am logged in as a moderator
    Then I should see the warning message "Pipeline Joinup community has not been executed for 91 days."
    ...
    Then I should not see the warning message "Pipeline Joinup community has not been executed for 91 days."
