...
Feature:
  ...
  Scenario: Configure a custom page to show a community content listing.
    ...
    And I press "Share"
    Then I should see the success message "Item was shared on the following challenges: Nintendo64"
    ...
    And I check "Nintendo64"
    And I press "Submit"
    Then I should see the success message "Item was unshared from the following challenges: Nintendo64"
