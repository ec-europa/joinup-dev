...
# aws s3 cp s3://ec-europa-db-dump/joinup/joinup_prod_cleaned.sql ./tmp/d6-joinup.sql
# aws s3 cp s3://ec-europa-db-dump/joinup/d6-joinup-test.sql ./tmp/d6-joinup-test.sql
