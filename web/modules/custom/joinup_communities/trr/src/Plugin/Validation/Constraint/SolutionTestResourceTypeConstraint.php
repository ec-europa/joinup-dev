...
class SolutionTestResourceTypeConstraint extends Constraint {
   ...
   * @var string
   */
  public $invalidTestScenarioMessage = 'Test resource type should be either "Test Suite", "Test Case", "Test Assertion" or "Document Assertion Set" when solution type is set to "[ABB129] Conformance Testing Component".';
   ...
   * @var string
   */
  public $invalidTestServiceOrComponentMessage = 'Test resource type should be either "Test Bed", "Messaging Adapter" or "Document Validator" when solution type is set to "Test service" or "[ABB129] Conformance Testing Component".';
