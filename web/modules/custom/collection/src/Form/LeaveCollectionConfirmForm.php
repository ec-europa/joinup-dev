...
class LeaveCollectionConfirmForm extends ConfirmFormBase {
  ...
  public function getDescription() {
    return $this->t("Are you sure you want to leave the %collection?<br />By leaving the collection you will be no longer able to publish content in it and to receive notification about the content you published.<br />In any case you will continue to have access to all the Collection's contents and in whenever you want you will be able to join the collection again.", [
