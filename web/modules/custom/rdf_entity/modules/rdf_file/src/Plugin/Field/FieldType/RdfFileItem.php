 ...
 * )
 */
class RdfFileItem extends EntityReferenceItem {
   ...
   * Commas are allowed by the end-user, but ultimately the value will
   * be stored as a space-separated list for compatibility with
