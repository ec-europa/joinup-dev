...
$this->assertRedirects(['catalogue/publisher/ordnance-survey'], $owner);
...
$this->assertReferences(['National authority'], $owner->field_owner_type);
$this->assertEquals('validated', $owner->field_owner_state->value);
$this->assertRedirects(['catalogue/publisher/forumstandaardisatienl'], $owner);
...
$this->assertEquals('validated', $owner->field_owner_state->value);
$this->assertRedirects(['catalogue/publisher/geodetic-institute-slovenia'], $owner);
...
$this->assertEquals('validated', $owner->field_owner_state->value);
$this->assertRedirects(['catalogue/publisher/european-banking-authority'], $owner);
...
$this->assertEquals('validated', $owner->field_owner_state->value);
$this->assertRedirects(['catalogue/publisher/world-wide-web-consortium'], $owner);
...
$this->assertEquals('validated', $owner->field_owner_state->value);
$this->assertRedirects(['catalogue/publisher/la-forja-de-guadalinex'], $owner);
