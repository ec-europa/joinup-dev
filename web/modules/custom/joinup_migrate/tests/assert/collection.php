...
$this->assertEquals('lambil', $collection->uid->entity->label());
...
$this->assertEquals('rsibilia', $collection->uid->entity->label());
$this->assertRedirects([], $collection);
...
$this->assertEquals('viktor.hristov', $collection->uid->entity->label());
$this->assertRedirects([], $collection);
...
$this->assertTrue($collection->get('field_ar_access_url')->isEmpty());
$this->assertEquals('tbenita', $collection->uid->entity->label());
...
$this->assertEquals('erics', $collection->uid->entity->label());
$this->assertRedirects([
  'node/82307',
